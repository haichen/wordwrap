...
data1:= "My point was that one parameter    accepting an array and the other parameter accepting a list of characters as a string would be inconsistent
. Requiring OmitList to be an array like [A_Space, A_Tab] would be more consistent but less efficient. (I'll probably just go with the easiest approach: leave OmitList exactly the way it is.)"
